    ...
    <div className='space-y-4 max-w-5xl mx-auto p-4'>
      <Card className='p-4 space-y-4'>
        <div className='grid grid-cols-2 gap-4'>
          <div>
            <Select value={fromJournal} onValueChange={setFromJournal}>
              <SelectTrigger>
          ...
          <div>
            <Select value={toJournal} onValueChange={setToJournal}>
              <SelectTrigger>
        ...
        <Button onClick={handleSubmit} disabled={!html || !fromJournal || !toJournal || loading}>
        ...
        {result && (
          <div className='space-y-4'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <Button variant='outline' size='sm' onClick={() => handleCopy(result.html)} title='Copy converted HTML'>
                <ClipboardCopy className='h-4 w-4 mr-1' />
                Copy Result
              </Button>
            </div>
            <Textarea value={result.html} readOnly rows={10} />
          </div>
        )}
      </Card>
    </div>
