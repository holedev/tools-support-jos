      ...
      <div className='space-y-2'>
        ...
        <Input
          ...
          onChange={(e) => {
            ...
            const port = value === "" ? 0 : Number.parseInt(value);
...
export function SMTPForm() {
  ...
  const validateConfig = () => {
    ...
    const port = Number.parseInt(config.port.toString());
  ...
  return (
    <Card className='w-full'>
      <CardHeader>
        ...
        <CardDescription>Test SMTP server connection and send test emails</CardDescription>
      </CardHeader>
      <CardContent>
        {showAlert && (
        ...
        <Tabs defaultValue='connection' className='space-y-6'>
          ...
          <TabsContent value='connection' className='space-y-6'>
            ...
            <div className='flex justify-end'>
              <Button type='button' onClick={(e) => handleAction(e, "check")} disabled={isLoading}>
