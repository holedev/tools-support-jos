...
const tools = [
	...
	},
	{
		name: "OJS Convert",
		description:
			"Convert OJS 3.3.0-21 XML files to OJS 3.1.2 format. Configurable options for English-only or bilingual content with customizable section settings.",
		...
		<div className="container space-y-8 py-6">
			<div className="flex flex-col gap-2">
				...
				<p className="text-muted-foreground text-lg">
					Explore our collection of development tools and utilities
				</p>
			</div>
			...
			<div className="grid gap-8 md:grid-cols-2">
				{tools.map((tool) => (
					<div
						key={tool.name}
						className="group hover:bg-accent/50 rounded-lg border p-6 transition-colors"
					>
						<div className="flex items-start gap-4">
							...
							<div className="flex-1 space-y-4">
								<div>
									<h2 className="group-hover:text-accent-foreground text-2xl font-semibold">
										{tool.name}
									</h2>
